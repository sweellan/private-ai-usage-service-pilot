...
- 总 buckets: 1,611
- 总 sessions: 6,046
- 总 tokens（MECE 总和）: 7,324,692,113
- 其中 input_non_cached_tokens: 657,397,806
- 其中 cached_input_read_tokens: 6,619,577,353
- 其中 output_non_reasoning_tokens: 25,546,936
- 其中 reasoning_output_tokens: 22,170,018
- 旧口径 totalTokens（不含 cached_input_read）: 705,114,760
- 总活跃时长（小时）: 3572.1
- 总会话跨度（小时）: 3745.4
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,236,580,719 tokens，其中 input 620,279,300 / cached 6,572,283,648 / output 25,285,251 / reasoning 18,732,520
...
- codex / 10_projects: 1,367,002,164 tokens，覆盖 157 buckets
...
- 2026-03-24: 总 10,013,736 = input 1,357,572 + cached 8,582,528 + output 48,044 + reasoning 25,592，sessions_started 4
