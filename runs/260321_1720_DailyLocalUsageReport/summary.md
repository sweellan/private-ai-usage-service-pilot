...
- 总 buckets: 1,577
- 总 sessions: 6,011
- 总 tokens（MECE 总和）: 7,132,032,602
- 其中 input_non_cached_tokens: 629,278,735
- 其中 cached_input_read_tokens: 6,456,037,641
- 其中 output_non_reasoning_tokens: 24,836,342
- 其中 reasoning_output_tokens: 21,879,884
- 旧口径 totalTokens（不含 cached_input_read）: 675,994,961
- 总活跃时长（小时）: 3330.4
- 总会话跨度（小时）: 3503.7
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,043,921,208 tokens，其中 input 592,160,229 / cached 6,408,743,936 / output 24,574,657 / reasoning 18,442,386
...
- codex / 10_projects: 1,206,174,114 tokens，覆盖 140 buckets
...
- 2026-03-21: 总 73,006,971 = input 5,275,693 + cached 67,371,136 + output 240,127 + reasoning 120,015，sessions_started 17
