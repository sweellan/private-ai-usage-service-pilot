...
- 总 buckets: 1,611
- 总 sessions: 6,046
- 总 tokens（MECE 总和）: 7,326,495,901
- 其中 input_non_cached_tokens: 657,567,067
- 其中 cached_input_read_tokens: 6,621,202,825
- 其中 output_non_reasoning_tokens: 25,552,989
- 其中 reasoning_output_tokens: 22,173,020
- 旧口径 totalTokens（不含 cached_input_read）: 705,293,076
- 总活跃时长（小时）: 3572.3
- 总会话跨度（小时）: 3745.6
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,238,384,507 tokens，其中 input 620,448,561 / cached 6,573,909,120 / output 25,291,304 / reasoning 18,735,522
...
- codex / Workspace: 1,383,065,670 tokens，覆盖 179 buckets
- codex / 10_projects: 1,368,348,712 tokens，覆盖 157 buckets
...
- 2026-03-24: 总 11,817,524 = input 1,526,833 + cached 10,208,000 + output 54,097 + reasoning 28,594，sessions_started 4
