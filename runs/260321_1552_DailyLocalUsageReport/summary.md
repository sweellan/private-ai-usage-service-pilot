...
- 总 buckets: 1,571
- 总 sessions: 6,000
- 总 tokens（MECE 总和）: 7,087,618,863
- 其中 input_non_cached_tokens: 626,157,285
- 其中 cached_input_read_tokens: 6,414,894,601
- 其中 output_non_reasoning_tokens: 24,738,145
- 其中 reasoning_output_tokens: 21,828,832
- 旧口径 totalTokens（不含 cached_input_read）: 672,724,262
- 总活跃时长（小时）: 3327.9
- 总会话跨度（小时）: 3501.1
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 6,999,628,210 tokens，其中 input 589,142,959 / cached 6,367,600,896 / output 24,476,460 / reasoning 18,407,895
...
- codex / 10_projects: 1,161,881,116 tokens，覆盖 137 buckets
...
- 2026-03-21: 总 28,593,232 = input 2,154,243 + cached 26,228,096 + output 141,930 + reasoning 68,963，sessions_started 6
