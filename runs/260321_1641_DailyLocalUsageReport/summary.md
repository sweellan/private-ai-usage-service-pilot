...
- 总 buckets: 1,573
- 总 sessions: 6,000
- 总 tokens（MECE 总和）: 7,099,145,109
- 其中 input_non_cached_tokens: 627,319,967
- 其中 cached_input_read_tokens: 6,425,189,641
- 其中 output_non_reasoning_tokens: 24,790,648
- 其中 reasoning_output_tokens: 21,844,853
- 旧口径 totalTokens（不含 cached_input_read）: 673,955,468
- 总活跃时长（小时）: 3329.0
- 总会话跨度（小时）: 3502.2
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,011,154,456 tokens，其中 input 590,305,641 / cached 6,377,895,936 / output 24,528,963 / reasoning 18,423,916
...
- codex / 10_projects: 1,173,407,362 tokens，覆盖 139 buckets
...
- 2026-03-21: 总 40,119,478 = input 3,316,925 + cached 36,523,136 + output 194,433 + reasoning 84,984，sessions_started 6
