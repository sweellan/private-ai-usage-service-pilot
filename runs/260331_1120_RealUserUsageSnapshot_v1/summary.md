...
- 总 buckets: 1,732
- 总 sessions: 6,064
- 总 tokens（MECE 总和）: 8,186,055,901
- 其中 input_non_cached_tokens: 788,104,077
- 其中 cached_input_read_tokens: 7,346,487,716
- 其中 output_non_reasoning_tokens: 28,175,379
- 其中 reasoning_output_tokens: 23,288,729
- 旧口径 totalTokens（不含 cached_input_read）: 839,568,185
- 总活跃时长（小时）: 4043.8
- 总会话跨度（小时）: 4220.9
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 8,095,062,402 tokens，其中 input 748,169,496 / cached 7,299,155,328 / output 27,906,475 / reasoning 19,831,103
- gemini-cli: 总 86,344,045 tokens，其中 input 37,036,740 / cached 45,603,876 / output 250,700 / reasoning 3,452,729
...
## 项目 Top 10
- codex / 10_projects: 2,200,973,162 tokens，覆盖 254 buckets
...
- codex / Workspace: 1,382,393,652 tokens，覆盖 185 buckets
- codex / 20260202_OpenClaw: 281,186,737 tokens，覆盖 56 buckets
- codex / 20250312_RepoCloneTests: 229,184,047 tokens，覆盖 46 buckets
- codex / 30_library: 133,071,902 tokens，覆盖 26 buckets
- gemini-cli / unknown: 86,344,045 tokens，覆盖 190 buckets
...
- 2026-03-30: 总 183,405,324 = input 20,857,199 + cached 161,576,704 + output 646,551 + reasoning 324,870，sessions_started 15
- 2026-03-31: 总 180,259,231 = input 13,747,716 + cached 165,794,048 + output 508,987 + reasoning 208,480，sessions_started 13
