...
- 总 buckets: 1,572
- 总 sessions: 6,000
- 总 tokens（MECE 总和）: 7,093,260,514
- 其中 input_non_cached_tokens: 626,897,763
- 其中 cached_input_read_tokens: 6,419,755,017
- 其中 output_non_reasoning_tokens: 24,771,202
- 其中 reasoning_output_tokens: 21,836,532
- 旧口径 totalTokens（不含 cached_input_read）: 673,505,497
- 总活跃时长（小时）: 3328.4
- 总会话跨度（小时）: 3501.6
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,005,269,861 tokens，其中 input 589,883,437 / cached 6,372,461,312 / output 24,509,517 / reasoning 18,415,595
...
- codex / 10_projects: 1,167,522,767 tokens，覆盖 138 buckets
...
- 2026-03-21: 总 34,234,883 = input 2,894,721 + cached 31,088,512 + output 174,987 + reasoning 76,663，sessions_started 6
