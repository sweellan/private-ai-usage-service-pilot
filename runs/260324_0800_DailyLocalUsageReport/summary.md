...
- 总 buckets: 1,611
- 总 sessions: 6,046
- 总 tokens（MECE 总和）: 7,324,118,901
- 其中 input_non_cached_tokens: 657,383,130
- 其中 cached_input_read_tokens: 6,619,020,425
- 其中 output_non_reasoning_tokens: 25,545,828
- 其中 reasoning_output_tokens: 22,169,518
- 旧口径 totalTokens（不含 cached_input_read）: 705,098,476
- 总活跃时长（小时）: 3572.1
- 总会话跨度（小时）: 3745.4
- parser 成功数: 10
- parser 失败数: 0
...
## 来源汇总
- codex: 总 7,236,007,507 tokens，其中 input 620,264,624 / cached 6,571,726,720 / output 25,284,143 / reasoning 18,732,020
...
- codex / 10_projects: 1,366,559,246 tokens，覆盖 157 buckets
...
- 2026-03-24: 总 9,440,524 = input 1,342,896 + cached 8,025,600 + output 46,936 + reasoning 25,092，sessions_started 4
